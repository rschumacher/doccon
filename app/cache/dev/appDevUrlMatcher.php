...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello')) {
            // ebbe_file_repository_homepage
            if (preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ebbe_file_repository_homepage')), array (  '_controller' => 'Ebbe\\FileRepositoryBundle\\Controller\\DefaultController::indexAction',));
            }

            // ebbe_doccon_homepage
            if (preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ebbe_doccon_homepage')), array (  '_controller' => 'Ebbe\\DocconBundle\\Controller\\DefaultController::indexAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/ebbe')) {
                if (0 === strpos($pathinfo, '/admin/ebbe/doccon/delivery')) {
                    // admin_ebbe_doccon_delivery_list
                    if ($pathinfo === '/admin/ebbe/doccon/delivery/list') {
                        return array (  '_controller' => 'Ebbe\\DocconBundle\\Controller\\DeliveryAdminController::listAction',  '_sonata_admin' => 'ebbe_doccon.admin.delivery',  '_sonata_name' => 'admin_ebbe_doccon_delivery_list',  '_route' => 'admin_ebbe_doccon_delivery_list',);
                    }

                    // admin_ebbe_doccon_delivery_create
                    if ($pathinfo === '/admin/ebbe/doccon/delivery/create') {
                        return array (  '_controller' => 'Ebbe\\DocconBundle\\Controller\\DeliveryAdminController::createAction',  '_sonata_admin' => 'ebbe_doccon.admin.delivery',  '_sonata_name' => 'admin_ebbe_doccon_delivery_create',  '_route' => 'admin_ebbe_doccon_delivery_create',);
                    }

                    // admin_ebbe_doccon_delivery_batch
                    if ($pathinfo === '/admin/ebbe/doccon/delivery/batch') {
                        return array (  '_controller' => 'Ebbe\\DocconBundle\\Controller\\DeliveryAdminController::batchAction',  '_sonata_admin' => 'ebbe_doccon.admin.delivery',  '_sonata_name' => 'admin_ebbe_doccon_delivery_batch',  '_route' => 'admin_ebbe_doccon_delivery_batch',);
                    }

                    // admin_ebbe_doccon_delivery_edit
                    if (preg_match('#^/admin/ebbe/doccon/delivery/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_ebbe_doccon_delivery_edit')), array (  '_controller' => 'Ebbe\\DocconBundle\\Controller\\DeliveryAdminController::editAction',  '_sonata_admin' => 'ebbe_doccon.admin.delivery',  '_sonata_name' => 'admin_ebbe_doccon_delivery_edit',));
                    }

                    // admin_ebbe_doccon_delivery_delete
                    if (preg_match('#^/admin/ebbe/doccon/delivery/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_ebbe_doccon_delivery_delete')), array (  '_controller' => 'Ebbe\\DocconBundle\\Controller\\DeliveryAdminController::deleteAction',  '_sonata_admin' => 'ebbe_doccon.admin.delivery',  '_sonata_name' => 'admin_ebbe_doccon_delivery_delete',));
                    }

                    // admin_ebbe_doccon_delivery_show
                    if (preg_match('#^/admin/ebbe/doccon/delivery/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_ebbe_doccon_delivery_show')), array (  '_controller' => 'Ebbe\\DocconBundle\\Controller\\DeliveryAdminController::showAction',  '_sonata_admin' => 'ebbe_doccon.admin.delivery',  '_sonata_name' => 'admin_ebbe_doccon_delivery_show',));
                    }

                    // admin_ebbe_doccon_delivery_export
                    if ($pathinfo === '/admin/ebbe/doccon/delivery/export') {
                        return array (  '_controller' => 'Ebbe\\DocconBundle\\Controller\\DeliveryAdminController::exportAction',  '_sonata_admin' => 'ebbe_doccon.admin.delivery',  '_sonata_name' => 'admin_ebbe_doccon_delivery_export',  '_route' => 'admin_ebbe_doccon_delivery_export',);
                    }

                }

                if (0 === strpos($pathinfo, '/admin/ebbe/filerepository/filelocation')) {
                    // admin_ebbe_filerepository_filelocation_list
                    if ($pathinfo === '/admin/ebbe/filerepository/filelocation/list') {
                        return array (  '_controller' => 'Ebbe\\FileRepositoryBundle\\Controller\\FileLocationAdminController::listAction',  '_sonata_admin' => 'ebbe_file_repository.admin.file_location',  '_sonata_name' => 'admin_ebbe_filerepository_filelocation_list',  '_route' => 'admin_ebbe_filerepository_filelocation_list',);
                    }

                    // admin_ebbe_filerepository_filelocation_create
                    if ($pathinfo === '/admin/ebbe/filerepository/filelocation/create') {
                        return array (  '_controller' => 'Ebbe\\FileRepositoryBundle\\Controller\\FileLocationAdminController::createAction',  '_sonata_admin' => 'ebbe_file_repository.admin.file_location',  '_sonata_name' => 'admin_ebbe_filerepository_filelocation_create',  '_route' => 'admin_ebbe_filerepository_filelocation_create',);
                    }

                    // admin_ebbe_filerepository_filelocation_batch
                    if ($pathinfo === '/admin/ebbe/filerepository/filelocation/batch') {
                        return array (  '_controller' => 'Ebbe\\FileRepositoryBundle\\Controller\\FileLocationAdminController::batchAction',  '_sonata_admin' => 'ebbe_file_repository.admin.file_location',  '_sonata_name' => 'admin_ebbe_filerepository_filelocation_batch',  '_route' => 'admin_ebbe_filerepository_filelocation_batch',);
                    }

                    // admin_ebbe_filerepository_filelocation_edit
                    if (preg_match('#^/admin/ebbe/filerepository/filelocation/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_ebbe_filerepository_filelocation_edit')), array (  '_controller' => 'Ebbe\\FileRepositoryBundle\\Controller\\FileLocationAdminController::editAction',  '_sonata_admin' => 'ebbe_file_repository.admin.file_location',  '_sonata_name' => 'admin_ebbe_filerepository_filelocation_edit',));
                    }

                    // admin_ebbe_filerepository_filelocation_delete
                    if (preg_match('#^/admin/ebbe/filerepository/filelocation/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_ebbe_filerepository_filelocation_delete')), array (  '_controller' => 'Ebbe\\FileRepositoryBundle\\Controller\\FileLocationAdminController::deleteAction',  '_sonata_admin' => 'ebbe_file_repository.admin.file_location',  '_sonata_name' => 'admin_ebbe_filerepository_filelocation_delete',));
                    }

                    // admin_ebbe_filerepository_filelocation_show
                    if (preg_match('#^/admin/ebbe/filerepository/filelocation/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_ebbe_filerepository_filelocation_show')), array (  '_controller' => 'Ebbe\\FileRepositoryBundle\\Controller\\FileLocationAdminController::showAction',  '_sonata_admin' => 'ebbe_file_repository.admin.file_location',  '_sonata_name' => 'admin_ebbe_filerepository_filelocation_show',));
                    }

                    // admin_ebbe_filerepository_filelocation_export
                    if ($pathinfo === '/admin/ebbe/filerepository/filelocation/export') {
                        return array (  '_controller' => 'Ebbe\\FileRepositoryBundle\\Controller\\FileLocationAdminController::exportAction',  '_sonata_admin' => 'ebbe_file_repository.admin.file_location',  '_sonata_name' => 'admin_ebbe_filerepository_filelocation_export',  '_route' => 'admin_ebbe_filerepository_filelocation_export',);
                    }
